...
export const authControllerSignup = (
    ...
    return axios.default.post(`/api/auth/signup`, signupInput, options)
}

export const getAuthControllerSignupMutationOptions = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    ...
    const mutationFn: MutationFunction<Awaited<ReturnType<typeof authControllerSignup>>, { data: SignupInput }> = (
        props
    ) => {
        const { data } = props ?? {}
 ...
 * @summary Signup a new user
 */
export const useAuthControllerSignup = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof authControllerSignup>>,
        TError,
        { data: SignupInput },
    ...
    >
    axios?: AxiosRequestConfig
}): UseMutationResult<Awaited<ReturnType<typeof authControllerSignup>>, TError, { data: SignupInput }, TContext> => {
...
export const authControllerLogin = (
    ...
    return axios.default.post(`/api/auth/login`, loginInput, options)
}

export const getAuthControllerLoginMutationOptions = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
    ...
    const mutationFn: MutationFunction<Awaited<ReturnType<typeof authControllerLogin>>, { data: LoginInput }> = (
        props
    ) => {
        const { data } = props ?? {}
 ...
 * @summary Login an existing user
 */
export const useAuthControllerLogin = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof authControllerLogin>>,
        TError,
        { data: LoginInput },
    ...
    >
    axios?: AxiosRequestConfig
}): UseMutationResult<Awaited<ReturnType<typeof authControllerLogin>>, TError, { data: LoginInput }, TContext> => {
...
export const authControllerRefreshToken = (
    ...
    return axios.default.post(`/api/auth/refresh-token`, refreshTokenInput, options)
}
 ...
 * @summary Refresh access token using a refresh token
 */
export const useAuthControllerRefreshToken = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof authControllerRefreshToken>>,
        TError,
        { data: RefreshTokenInput },
...
export const postsControllerCreate = (
    ...
    return axios.default.post(`/api/posts`, createPostInput, options)
}

export const getPostsControllerCreateMutationOptions = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
...
> => {
    ...
    const mutationFn: MutationFunction<Awaited<ReturnType<typeof postsControllerCreate>>, { data: CreatePostInput }> = (
        props
    ) => {
        const { data } = props ?? {}
 ...
 * @summary Create a new post
 */
export const usePostsControllerCreate = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof postsControllerCreate>>,
        TError,
        { data: CreatePostInput },
 ...
 */
export const postsControllerGetAllPosts = (options?: AxiosRequestConfig): Promise<AxiosResponse<PostResponse[]>> => {
    return axios.default.get(`/api/posts`, options)
}
...
export const getPostsControllerGetAllPostsQueryOptions = <
    ...
    TError = AxiosError<unknown>,
>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof postsControllerGetAllPosts>>, TError, TData>
    axios?: AxiosRequestConfig
}) => {
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof postsControllerGetAllPosts>>> = ({ signal }) =>
        postsControllerGetAllPosts({ signal, ...axiosOptions })
...
export const postsControllerUserPosts = (
    ...
    return axios.default.get(`/api/posts/user/${userId}`, options)
}
...
>(
    userId: string,
    options?: {
        query?: UseQueryOptions<Awaited<ReturnType<typeof postsControllerUserPosts>>, TError, TData>
        axios?: AxiosRequestConfig
    }
) => {
    const { query: queryOptions, axios: axiosOptions } = options ?? {}
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof postsControllerUserPosts>>> = ({ signal }) =>
        postsControllerUserPosts(userId, { signal, ...axiosOptions })
...
export const postsControllerPost = (
    ...
    return axios.default.get(`/api/posts/${postId}`, options)
}
...
>(
    postId: string,
    options?: {
        query?: UseQueryOptions<Awaited<ReturnType<typeof postsControllerPost>>, TError, TData>
        axios?: AxiosRequestConfig
    }
) => {
    const { query: queryOptions, axios: axiosOptions } = options ?? {}
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof postsControllerPost>>> = ({ signal }) =>
        postsControllerPost(postId, { signal, ...axiosOptions })
